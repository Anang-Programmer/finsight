  ...
  return (
    <div className="stagger-children" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '8px' }}>
        ...
        <div className="header-actions-mobile" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '12px' }}>
          ...
          {/* Health Score Badge */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', background: 'var(--surface-elevated)', padding: '10px 16px', borderRadius: 'var(--radius-full)', border: '1px solid var(--hairline-dark)', boxShadow: '0 4px 20px rgba(0,0,0,0.2)' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
              ...
              <span style={{ fontSize: '14px', fontWeight: '600', color: healthScore >= 80 ? 'var(--accent-teal)' : healthScore >= 50 ? 'var(--accent-warning)' : 'var(--accent-danger)' }}>
                {healthScore >= 80 ? 'Sangat Sehat' : healthScore >= 50 ? 'Cukup Sehat' : 'Kritis'}
              </span>
            </div>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'var(--surface-deep)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '15px', fontWeight: '700', color: healthScore >= 80 ? 'var(--accent-teal)' : healthScore >= 50 ? 'var(--accent-warning)' : 'var(--accent-danger)', border: `2px solid ${healthScore >= 80 ? 'var(--accent-teal)' : healthScore >= 50 ? 'var(--accent-warning)' : 'var(--accent-danger)'}`, flexShrink: 0 }}>
              {healthScore}
            </div>
          </div>
        </div>
